...
describe('BookingController', () => {
    ...
    describe('POST /bookings', () => {
        it('creates a booking for the current user', () => {
            ...
            controller.create(student as any, dto);
    ...
    describe('GET /bookings/me', () => {
        it('returns own bookings with parsed paging', async () => {
            ...
            const res = await controller.findMine(student as any, '2', '10');
        ...
        it('clamps limit to 100', async () => {
            ...
            await controller.findMine(student as any, '1', '500');
    ...
    describe('GET /bookings (all)', () => {
        it('lists all bookings with filters', async () => {
            ...
            await controller.findAll('1', '20', 'u9', 'DEVICE' as any, 'PENDING' as any);
    ...
    describe('GET /bookings/:id', () => {
        ...
        it('allows staff to view any booking', async () => {
            ...
            await expect(controller.findOne('b1', staff as any)).resolves.toBeTruthy();
        });
