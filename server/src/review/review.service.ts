...
export class ReviewService {
  ...
  async create(
    ...
    if (!completed) {
      throw new BadRequestException(
        'You can only review books you have borrowed and returned',
      );
    }
    ...
    await this.points.applyFixed(userId, 'BOOK_REVIEW', {
      reviewId: review.id,
    });
  ...
  async remove(
    ...
    const isStaff =
      actorRole === Role.ADMIN || actorRole === Role.LIBRARY_STAFF;
