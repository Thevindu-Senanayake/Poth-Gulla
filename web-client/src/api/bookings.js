...
export const getBooking = (id) =>
  api.get(`/bookings/${id}`).then((r) => adaptBooking(r.data));
export const approveBooking = (id) =>
  api.patch(`/bookings/${id}/approve`).then((r) => adaptBooking(r.data));
export const rejectBooking = (id) =>
  api.patch(`/bookings/${id}/reject`).then((r) => adaptBooking(r.data));
export const cancelBooking = (id) =>
  api.post(`/bookings/${id}/cancel`).then((r) => adaptBooking(r.data));
export const cancelAnyBooking = (id) =>
  api.post(`/bookings/${id}/cancel-any`).then((r) => adaptBooking(r.data));
