...
export const getUser = (id) =>
  api.get(`/users/${id}`).then((r) => adaptUser(r.data));

// PATCH /users/:id  (ADMIN) - name, role, userPoints, tier (tier<->points coupled by backend)
export const updateUser = (id, body) =>
  api.patch(`/users/${id}`, body).then((r) => adaptUser(r.data));

export const disableUser = (id) =>
  api.patch(`/users/${id}/disable`).then((r) => adaptUser(r.data));
export const enableUser = (id) =>
  api.patch(`/users/${id}/enable`).then((r) => adaptUser(r.data));
