...
export default function Users() {
    ...
    const { data, loading, error, reload } = useFetch(() => listUsers({ limit: 500 }), []);
                ...
                {paged.slice.map((u, i) => (
                    <div
                        ...
                        style={{
                            ...
                            gridTemplateColumns: '2fr 1fr 1fr 1fr 1fr 100px',
                            padding: '14px 20px',
                            borderBottom: i < paged.slice.length - 1 ? '1px solid #f0f0f6' : 'none',
                            alignItems: 'center',
                        }}
                    >
                        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                            ...
                            <div>
                                <div style={{ fontSize: 13, fontWeight: 600, color: '#1a1b2e' }}>
                                    {u.name}
                                </div>
