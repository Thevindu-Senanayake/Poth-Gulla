        ...
        >
            <div style={{ marginBottom: 24 }}>
                ...
                <p style={{ color: '#7c7e93', fontSize: 13, margin: 0 }}>
                    Reserve a quiet space - bookings route instantly unless the slot clashes.
                </p>
            </div>
            ...
            >
                ...
                <div>
                    ...
                    <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.65)' }}>
                        Scan the QR code at the room entrance within 15 minutes of your booking
                        start to confirm your session.
                    </div>
                </div>
            </div>
        </div>
