...
import { getBook, getDevice, getRoom } from '../../api/catalogue';
import { Loading, ErrorState } from '../../components/States';

export default function ResourceDetail() {
    const { resourceId } = useParams();
    const navigate = useNavigate();
    const { openBooking, user } = useApp();
    ...
    useEffect(() => {
        ...
        Promise.any([getBook(resourceId), getDevice(resourceId), getRoom(resourceId)])
            .then((res) => {
                if (alive) {
                    setResource(res);
                    setLoading(false);
