...
export default function Waitlist() {
    ...
    const { data, loading, error, reload } = useFetch(() => loadEnrichedWaitlist(), []);
    ...
    const wlEntries = (data || []).map((w, i) => ({
        ...
        position: i + 1,
        title: w.title,
        author: RESOURCE_LABEL[w.resourceLabel] || RESOURCE_LABEL[w.resourceType] || w.resourceType,
    ...
    async function leave(entry) {
        try {
            ...
            showToast(e?.response?.data?.message ?? 'Could not leave waitlist');
        }
    }
        ...
        >
            ...
            <div style={{ marginBottom: 20 }}>
                ...
                <p style={{ color: '#7c7e93', fontSize: 13, margin: 0 }}>
                    Your current waitlist positions and priority scores
                </p>
            </div>
            ...
            >
                ...
                <div>
                    ...
                    >
                        Your position in the queue is determined by a weighted score combining your
                        tier standing and role type.
                    </div>
                    <code
                        style={{
