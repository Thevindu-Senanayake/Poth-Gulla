...
export default function RoomCheckin() {
    ...
    async function submit(value) {
        ...
        try {
            ...
            const msg = e?.response?.data?.message ?? 'Could not check into this room.';
            showToast(msg);
    ...
    return (
        ...
        >
            ...
            <p style={{ fontSize: 13, color: '#7c7e93', margin: '0 0 24px' }}>
                Scan the QR code on a study-room door to claim it without a prior booking. If the
                room is already reserved you'll see why.
            </p>
            ...
            >
                {scanning ? (
                    <>
                        <QRScanner onDetect={(v) => submit(v)} onError={() => setScanning(false)} />
                        <button
