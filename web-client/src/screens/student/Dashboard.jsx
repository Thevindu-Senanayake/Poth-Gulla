...
export default function Dashboard() {
    ...
    const stats = [
        ...
        },
        {
            ...
            iconBg: '#fef4e6',
            iconColor: '#f59e0b',
            iconPath: STAT_ICONS.points,
            trend: `${toNext} to next tier`,
            trendColor: '#d97706',
        },
        {
            label: 'Tier',
            ...
            iconBg: '#dbeafe',
            iconColor: '#2563eb',
            iconPath: STAT_ICONS.tier,
            trend: tierNum >= 5 ? 'max tier' : 'keep earning',
            trendColor: '#7c7e93',
        },
    ];
    ...
    return (
        ...
        >
            ...
            <div
                style={{
                    background: 'linear-gradient(125deg,#0c2a1a 0%,#15803d 60%,#22c55e 100%)',
                    borderRadius: 16,
                    padding: '30px 34px',
                    marginBottom: 28,
                    position: 'relative',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1.55fr 1fr', gap: 18 }}>
                ...
                >
                    ...
                    {activeLoans.length === 0 ? (
                        <div style={{ fontSize: 13, color: '#9b9db2', padding: '14px 0' }}>
