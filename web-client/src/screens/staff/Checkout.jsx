            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 18 }}>
              ...
              barcode scanner is wired up (it types into the focused input). */}
                ...
                >
                    ...
                    >
                        <li>
                            <strong>Checkout</strong> - scan the member's <em>booking QR</em> (an
                            APPROVED booking) then the item's <em>asset tag</em>. The copy/device is
                            marked borrowed.
                        </li>
                        <li>
                            <strong>Return</strong> - scan the item's <em>asset tag</em> and pick a
                            condition. Points are scored automatically and the next waitlist entry
                            is auto-promoted.
                        </li>
                        <li>
                    ...
                    >
                        A hardware scanner simply types into the fields on the left - no camera
