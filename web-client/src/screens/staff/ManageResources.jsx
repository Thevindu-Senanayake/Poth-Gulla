...
export default function ManageResources() {
    ...
    const loans = devices
        ...
        .map((d) => {
            ...
            return {
                device: d,
                borrower: b ? userName.get(b.userId) || 'Unknown member' : 'Unknown member',
                due,
    ...
    const counts = [
        ...
        {
            value: [...devices, ...rooms].filter((r) => r.raw?.status === 'UNDER_MAINTENANCE')
                .length,
    ...
    return (
        ...
        >
            ...
            {tab === 'books' && (
                ...
                >
                    {books.length === 0 ? (
                        <Empty label={q ? `No books match "${searchQuery}".` : 'No books yet.'} />
                    ) : (
                                        ...
                                        >
                                            {copiesLoading && !copies[book.id] ? (
                                                ...
                                                <>
                                                    ...
                                                    >
                                                        Borrowed copies can't be retired until
                                                        they're returned. Lost copies can be marked
                                                        found to restore availability.
                                                    </div>
                                                </>
                                            )}
                                        </div>
            ...
            {tab === 'devices' && (
                ...
                >
                    ...
                    >
                        {['Device', 'Serial', 'Tier', 'Status', 'Maintenance'].map((h, i) => (
                            <div
                                key={i}
                                style={{
                                    fontSize: 11,
                    ...
                    {devices.length === 0 ? (
                        <Empty
                            label={q ? `No devices match "${searchQuery}".` : 'No devices yet.'}
                        />
                    ) : (
                        devicePage.slice.map((d, i) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div style={{ fontSize: 12, color: '#3a3b4e' }}>T{d.tier}</div>
                                    ...
                                    <div>
                                        ...
                                        <button
                                            ...
                                            disabled={borrowed}
                                            title={
                                                borrowed ? 'Cannot delete a borrowed device' : ''
                                            }
                                            style={{
                                                background: '#fff',
            ...
            {tab === 'rooms' && (
                ...
                >
                    ...
                    {rooms.length === 0 ? (
                        <Empty
                            label={q ? `No rooms match "${searchQuery}".` : 'No study rooms yet.'}
                        />
                    ) : (
            ...
            {tab === 'loans' && (
                ...
                >
                    ...
                    >
                        {['Device', 'Serial', 'Borrowed by', 'Due', 'Manage'].map((h, i) => (
                            <div
                                key={i}
                                style={{
                                    fontSize: 11,
                    ...
                    {loans.length === 0 ? (
                        ...
                        loans.map((ln, i) => (
                            ...
                            >
                                <div style={{ fontSize: 13, fontWeight: 700, color: '#1a1b2e' }}>
                                    {ln.device.title}
                                </div>
                                <div
                                    style={{
                                ...
                                <div style={{ fontSize: 13, color: '#3a3b4e' }}>{ln.borrower}</div>
                                <div>
                                    {ln.due ? (
                                        <span
                                            style={{
