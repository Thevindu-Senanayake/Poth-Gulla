...
export default function Overdue() {
    ...
    async function sweep() {
        ...
        try {
            ...
            showToast(
                `Sweep done · ${r.borrowingsProcessed ?? 0} borrowings, ${r.noShowsProcessed ?? 0} no-shows`
            );
            refresh();
        } catch (e) {
        ...
        >
            ...
            >
                ...
                <button
                    ...
                    disabled={sweeping}
                    style={{
                        background: sweeping ? '#86efac' : '#16a34a',
                        color: '#fff',
                        border: 'none',
                        borderRadius: 9,
                        padding: '10px 18px',
            ...
            <div
                style={{
                    background: 'linear-gradient(125deg,#052e16 0%,#166534 100%)',
                    borderRadius: 13,
                    padding: '16px 20px',
                    display: 'flex',
                    gap: 14,
            ...
            >
                ...
                <div>
                    ...
                    >
                        The sweep marks late items, applies point penalties, sets recall flags at
                        day 2, and escalates to admin at day 7 - notifying borrowers and staff. Run
                        it manually here or let the scheduled job handle it.
                    </div>
                </div>
            </div>
        </div>
