...
export default function BookingModal() {
  const { bookingModal, setBookingModal, qrCells, showToast, refresh } =
    useApp();
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: 12, color: "#b45309", lineHeight: 1.5 }}>
                This device requires Tier 4 or above, or explicit admin
                approval. Your request will be reviewed by a staff member.
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: 12, color: "#be185d", lineHeight: 1.5 }}>
                You can join the waitlist. Add a justification message to
                improve your priority score — staff may promote you ahead of the
                queue.
              </div>
            </div>
          </div>
