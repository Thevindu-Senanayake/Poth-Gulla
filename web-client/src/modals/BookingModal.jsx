...
export default function BookingModal() {
    const { bookingModal, setBookingModal, qrCells, showToast, refresh } = useApp();
    ...
    const BtnRow = ({ children }) => (
        <div style={{ display: 'flex', gap: 10, padding: '16px 24px 22px' }}>{children}</div>
    );
                ...
                <div style={{ padding: '18px 24px' }}>
                    ...
                    <div style={{ display: 'flex', gap: 12, marginBottom: 16 }}>
                        <DatePicker
                            label="Pickup date"
                            value={bookDate}
                            onChange={(v) => setDate('bookDate', v)}
                        />
                        <DatePicker
                            label="Return date"
                            value={bookReturn}
                            onChange={(v) => setDate('bookReturn', v)}
                        />
                    </div>
                    ...
                    >
                        ...
                        <span style={{ fontSize: 12, color: '#16a34a', fontWeight: 600 }}>
                            Available now · Pick up at front desk
                        </span>
                    </div>
                </div>
                <BtnRow>
                    <CancelBtn />
                    <PrimaryBtn onClick={submitBooking}>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div style={{ fontSize: 12, color: '#b45309', lineHeight: 1.5 }}>
                                This device requires Tier 4 or above, or explicit admin approval.
                                Your request will be reviewed by a staff member.
                            </div>
                        </div>
                    </div>
        ...
        return (
            <Overlay onClose={close}>
                ...
                >
                    ...
                    >
                        Your booking request for <strong>{resource?.title}</strong> is pending staff
                        review. You'll be notified when it's approved or declined.
                    </div>
                </div>
                <BtnRow>
                    <button
